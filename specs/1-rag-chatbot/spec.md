...
### User Story 1 - Ask Questions and Get Cited Answers (Priority: P1) {: #user-story-1-ask-questions}
...
### User Story 2 - Query with Selected Text Context (Priority: P2) {: #user-story-2-selected-text}
...
### User Story 3 - Review Conversation History (Priority: P3) {: #user-story-3-conversation-history}
