...
### User Story 1 - Ask Questions and Get Cited Answers (Priority: P1) {: #user-story-1}
...
### User Story 2 - Query with Selected Text Context (Priority: P2) {: #user-story-2}
...
### User Story 3 - Review Conversation History (Priority: P3) {: #user-story-3}
